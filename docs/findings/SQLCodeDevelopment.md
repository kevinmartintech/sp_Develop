...
- See [Using Deprecated or Discontinued Feature](/best-practices-and-findings/sql-code-conventions#using-deprecated-or-discontinued-feature)
...
- See [Using Missing Indexes Recommendations](/best-practices-and-findings/sql-code-conventions#using-missing-indexes-recommendations)
...
- See [Not Using SET XACT_ABORT ON](/best-practices-and-findings/sql-code-conventions#not-using-set-xact_abort-on)
...
- See [Not Using Transactions](/best-practices-and-findings/sql-code-conventions#not-using-transactions)
...
- See [Not Using BEGIN END](/best-practices-and-findings/sql-code-conventions#not-using-begin-end)
- See [Not Using Semicolon to Terminate Statements](/best-practices-and-findings/sql-code-conventions#not-using-semicolon-to-terminate-statements)
...
- See [Not Using Semicolon to Terminate Statements](/best-practices-and-findings/sql-code-conventions#not-using-semicolon-to-terminate-statements)
- See [Not Using Semicolon THROW](/best-practices-and-findings/sql-code-conventions#not-using-semicolon-throw)
...
- See [Not Using BEGIN END](/best-practices-and-findings/sql-code-conventions#not-using-begin-end)
- See [Not Using Semicolon THROW](/best-practices-and-findings/sql-code-conventions#not-using-semicolon-throw)
- See [Using RAISERROR Instead of THROW](/best-practices-and-findings/sql-code-conventions#using-raiserror-instead-of-throw)
...
- See [Not Using SQL Formatting](/best-practices-and-findings/sql-code-conventions#not-using-sql-formatting)
...
- See [Using a Non-SARGable Expression in a WHERE Clause](/best-practices-and-findings/sql-code-conventions#using-a-non-sargable-expression-in-a-where-clause)
...
- See [Not Specifying JOIN Type](/best-practices-and-findings/sql-code-conventions#not-specifying-join-type)
